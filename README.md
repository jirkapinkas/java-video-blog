...
<p>To deploy on Heroku change in pom.xml: <code>&lt;argument&gt;javavids&lt;/argument&gt;</code> change "javavids" to your application name in Heroku and run: <code>mvn clean install -P heroku</code>
